...
function cb(error,response,html){
    if(error){
        console.log("Some error while requesting",error);
    }else{
        ...
        firstMatchCommentBox.querySelector(".d-flex.match-comment-padder.align-items-center");
        let lastBallComment = firstMatchCommentBox.querySelector(".match-comment-long-text > p").textContent;
